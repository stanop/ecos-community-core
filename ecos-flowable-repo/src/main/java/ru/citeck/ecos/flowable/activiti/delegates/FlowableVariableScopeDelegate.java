...
public class FlowableVariableScopeDelegate implements VariableScope {

    private final org.flowable.variable.api.delegate.VariableScope impl;

    public FlowableVariableScopeDelegate(org.flowable.variable.api.delegate.VariableScope impl) {
        this.impl = impl;
    }
