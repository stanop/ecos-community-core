 ...
 * statuses.
 *
 * Temporary class; need just for updating by orders-share AMP only.
 * TODO: remove in future, use CaseStatusEvaluator instead (idocs-share module, same logic)
 *
 * @autor Andrew Timokhin
 */
public class OrdersCaseStatusEvaluator extends BaseEvaluator {
