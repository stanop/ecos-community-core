...
(function() {
	...
	var managerRole = orgstruct.getUserManager(userName),
        managerUsers = managerRole ? managerRole.allUsers : [];
        
    model.managerRole = managerRole;
    model.managerUsers = managerUsers;
})();