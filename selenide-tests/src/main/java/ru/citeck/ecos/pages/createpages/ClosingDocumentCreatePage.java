...
public class ClosingDocumentCreatePage extends CreatePage{
    ...
    {
        $("[id *= \"default-cm_name\"]").setValue("Act"+Math.random());
    }
    @Override
    public void setDocumentNumber()
    {
        $("[id *= \"contracts_closingDocumentNumber\"]").setValue("№"+Math.random()*100);
    }
    ...
    {
        $("[id *= \"closingDocumentDate\"] input").setValue("2016-06-29");
    }
