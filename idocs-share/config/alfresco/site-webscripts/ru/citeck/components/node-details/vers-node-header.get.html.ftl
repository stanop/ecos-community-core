        ...
        <@uniqueIdDiv>
            ...
            <div class="node-header">
                ...
                <div class="node-info">
                    ...
                    <!-- Title and Version -->
                    <h1 class="thin dark">
                    ${displayName}<#if !isContainer><span id="document-version" class="document-version">
                        <#if item.nodeRef?string?matches(".*version2Store.*")>
                            ${item.node.properties["ver2:versionLabel"]}
                        <#else>
                            ${item.version}
                        </#if>
                    </span></#if>
