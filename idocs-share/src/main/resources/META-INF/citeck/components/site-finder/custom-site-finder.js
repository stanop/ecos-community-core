...
(function()
{
    ...
    * @constructor
    */
   Citeck.CustomSiteFinder = function(htmlId)
   {
      Citeck.CustomSiteFinder.superclass.constructor.call(this, "Citeck.CustomSiteFinder", htmlId, ["button", "container", "datasource", "datatable", "json"]);
   ...
   YAHOO.extend(Citeck.CustomSiteFinder, Alfresco.component.Base,
   {
      /**
      ...
      _setupDataTable: function SiteFinder_setupDataTable()
      {
          ...
          * These MUST be inline in order to have access to the Citeck.CustomSiteFinder class (via the "me" variable).
          */
         var me = this;
