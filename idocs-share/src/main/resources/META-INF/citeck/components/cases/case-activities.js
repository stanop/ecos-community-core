...
Activity
    ...
    .computed('startDate', function() { return this.actualStartDate() || this.plannedStartDate(); })
    .computed('endDate', function() { return this.actualEndDate() || this.plannedEndDate(); })
    
    .computed('startDateText', function() { return formatDate(this.startDate(), dateFormat, "-"); })
    .computed('startTimeText', function() { return formatDate(this.startDate(), timeFormat, ""); })
    .computed('endDateText', function() { return formatDate(this.endDate(), dateFormat, "-"); })
    .computed('endTimeText', function() { return formatDate(this.endDate(), timeFormat, ""); })
    ...
    .method('toggle', function() { this.opened(!this.opened()); })
    ;
