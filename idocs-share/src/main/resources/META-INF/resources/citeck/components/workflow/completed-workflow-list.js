...
/**
 * CompletedWorkflowList component.
 * This is WorkflowList fork with completed task support  
 *
 * @namespace Citeck
 * @class Citeck.CompletedWorkflowList
 */
...
(function()
{
     ...
     * @return {Citeck.CompletedWorkflowList} The new DocumentList instance
     * @constructor
     */
    Citeck.CompletedWorkflowList = function(htmlId)
    {
        Citeck.CompletedWorkflowList.superclass.constructor.call(this, "Citeck.CompletedWorkflowList", htmlId, ["button", "menu", "container", "datasource", "datatable", "paginator", "json", "history"]);
     ...
     */
    YAHOO.extend(Citeck.CompletedWorkflowList, Alfresco.component.Base);

    /**
     * Augment prototype with Common Workflow actions to reuse createFilterURLParameters
     */
    YAHOO.lang.augmentProto(Citeck.CompletedWorkflowList, Alfresco.action.WorkflowActions);

    /**
     * Augment prototype with main class implementation, ensuring overwrite is enabled
     */
    YAHOO.lang.augmentObject(Citeck.CompletedWorkflowList.prototype,
        {
            /**
