    ...
    <div id="${el}-body" class="users">
        ...
        <div id="${el}-view" class="hidden">
            ...
            <div id="${el}-view-main" class="view-main separator">
                ...
                <div class="photo-row">
                    <div class="photo">
                        <img class="view-photoimg" src="${url.context}/res/components/images/no-user-photo-64.png"
                             alt=""/>
                    </div>
                ...
                <div class="field-row">
                    <span class="field-label-right">СНИЛС:</span>
        ...
        <div id="${el}-create" class="hidden">
            ...
            <form id="${el}-create-form">
                <div id="${el}-create-main" class="create-main">
                    ...
                    <div class="field-row">
                        <span class="crud-label"><input type="checkbox"
                                                        id="${el}-create-disableaccount"/>&nbsp;${msg("label.disableaccount")}</span>
                    </div>
                </div>
        ...
        <div id="${el}-update" class="hidden">
            ...
            <form id="${el}-update-form">
                <div id="${el}-update-main" class="update-main">
                    ...
                    <div class="field-row">
                        <span class="crud-label"><input type="checkbox"
                                                        id="${el}-update-disableaccount"/>&nbsp;${msg("label.disableaccount")}</span>
                    </div>

                    <div class="header-bar">${msg("label.photo")}</div>
                    <div class="update-photo-row">
                        <div class="photo">
                            <img id="${el}-update-photoimg" class="update-photoimg left"
                                 src="${url.context}/res/components/images/no-user-photo-64.png" alt=""/>
