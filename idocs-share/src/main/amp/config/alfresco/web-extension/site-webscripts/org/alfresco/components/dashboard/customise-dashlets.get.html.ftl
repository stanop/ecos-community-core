...
<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link rel="stylesheet" type="text/css" href="${url.context}/res/citeck/components/dashboard/customise-dashlets.css" group="dashboard"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script type="text/javascript" src="${url.context}/res/js/alfresco-dnd.js" group="dashboard"/>
   <@script type="text/javascript" src="${url.context}/res/citeck/components/dashboard/customise-dashlets.js" group="dashboard"/>
</@>
...
<@markup id="html">
   <@uniqueIdDiv>
      <div class="customise-dashlets">
         ...
         <div id="${args.htmlid}-wrapper-div" class="dashlets noOfColumns${currentLayout.noOfColumns}">
            <div class="usedActions" style="display:none;">&nbsp;</div>
            <#list columns as column>
               <div class="column" id="${args.htmlid}-column-div-${column_index + 1}" <#if (column_index >= currentLayout.noOfColumns)>style="display: none;"</#if>>
                  <h3>${msg("header.column", column_index + 1)}</h3>
            ...
            <div id="${args.htmlid}-available-div" class="column available">
