...
<#if item??>
   ...
   <div class="node-header">
	  ...
	  <#if node.properties["cm:versionLabel"]??>	  	
		<#assign version = node.properties["cm:versionLabel"]>
	  <#else>
	  	<#assign version = item.version>
	  </#if>	
         <!-- Title and Version -->
         <h1 class="thin dark">
            ${displayName}<#if !isContainer><span class="document-version">${version}</span></#if>
         </h1>
         ...
         <div>
            ...
            ${msg("label.modified-by-user-on-date", modifierLink, xmldate(modifyDate.iso8601))}
