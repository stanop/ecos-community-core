...
class NodeViewsFilter {
    ...
    private NodeViewElement resolveElement(NodeViewElement element, List<SearchNode> searchRoots) {
        ...
        List<NodeViewElement> children = new LinkedList<>();
    ...
    private static class SearchNode {
        ...
        private void registerElement(
                NodeViewElement element, Key key, 
                Map<Key, SearchNode> elementsMap) {
            SearchNode node = getOrCreateAndPut(elementsMap, 
                    key, 
                    searchNodeProducer);
        ...
        private NodeViewElement search(NodeViewElement element,
                Predicate predicate, List<SearchNode> nodes) {
