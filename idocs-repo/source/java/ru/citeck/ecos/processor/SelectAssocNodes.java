 ...
 */
public class SelectAssocNodes extends AbstractDataBundleLine {
    ...
    public DataBundle process(DataBundle input) {
        ...
        if (nodeService.exists(parent)) {
            ...
            for(AssociationRef assoc : assocs) {
                if(nodeService.getProperty(assoc.getTargetRef(), ContentModel.PROP_NAME).equals(name)) {
                    childNode = assoc.getTargetRef();
                    break;
                }
            }
