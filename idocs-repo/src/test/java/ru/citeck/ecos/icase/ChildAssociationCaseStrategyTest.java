...
import ru.citeck.ecos.icase.element.AssociationCaseElementDAOImpl;
 ...
 */
@Ignore
public class ChildAssociationCaseStrategyTest extends BaseCaseStrategyTest {
    ...
    protected NodeRef createConfigNode() {
        ...
        properties.put(ICaseModel.PROP_ASSOC_TYPE, "child");
        properties.put(ICaseModel.PROP_ASSOC_NAME, ContentModel.ASSOC_CONTAINS);
