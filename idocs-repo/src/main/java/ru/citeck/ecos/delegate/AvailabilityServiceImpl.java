...
public class AvailabilityServiceImpl implements AvailabilityService
{
	...
	public boolean getUserAvailability(String userName) {
		...
		Boolean available = (Boolean) nodeService.getProperty(person, DelegateModel.PROP_AVAILABLE);
	...
	public void setUserAvailability(String userName, boolean availability) {
		NodeRef person = authorityHelper.needUser(userName);
		nodeService.setProperty(person, DelegateModel.PROP_AVAILABLE, availability);
		// note: delegate listener, related to availability change, should be called via behaviour mechanism
	}
