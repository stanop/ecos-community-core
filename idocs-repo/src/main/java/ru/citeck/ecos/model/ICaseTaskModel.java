...
public class ICaseTaskModel {
    ...
    public static final QName TYPE_HUMAN_TASK = QName.createQName(NAMESPACE, "humanTask");
    public static final QName TYPE_PROCESS_TASK = QName.createQName(NAMESPACE, "processTask");
