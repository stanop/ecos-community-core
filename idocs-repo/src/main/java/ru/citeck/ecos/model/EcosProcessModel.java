...
public interface EcosProcessModel {
    ...
    QName ASPECT_HAS_DEFINITION_REVISION_ID = QName.createQName(NAMESPACE, "hasDefinitionRevisionId");
    ...
    QName PROP_DEFINITION_REVISION_ID = QName.createQName(NAMESPACE, "definitionRevisionId");
