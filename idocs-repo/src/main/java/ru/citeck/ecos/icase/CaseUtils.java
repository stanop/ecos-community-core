...
public class CaseUtils {
    ...
    public static NodeRef getCaseFolder(
        ...
        QName folderAssocType = config.getFolderAssocName();
        if (folderAssocType == null) {
            return null;
        }
    ...
    public static NodeRef createCaseFolder(
        ...
        QName folderType = config.getFolderType();
        if (folderType == null) {
            return null;
        }

        QName assocType = config.getFolderAssocName();
        if (assocType == null) {
            return null;
        }

        QName assocName = QName.createQNameWithValidLocalName(NamespaceService.CONTENT_MODEL_1_0_URI, folderName);
        Map<QName, Serializable> properties = Collections.singletonMap(ContentModel.PROP_NAME, folderName);
    ...
    public static List<NodeRef> getSubFolders(
        ...
        List<NodeRef> result = new ArrayList<>(folders.size());
    ...
    public static List<NodeRef> getElements(
        ...
        List<NodeRef> result = new ArrayList<>(elements.size());
    ...
    public static CaseElementDAO<ElementConfigDto> getStrategy(ElementConfigDto config,
                                                               CaseElementServiceImpl caseElementService) {
