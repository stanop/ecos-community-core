...
public class NumericPropertyValueComparator implements PropertyValueComparator
{
            ...
            ComparePropertyValueOperation operation)
    {
        ...
        Double propertyNumber = ConvertUtils.convertSingleValue(propertyValue, Double.class);
        Double compareNumber = ConvertUtils.convertSingleValue(compareValue, Double.class);
        
        switch(operation) {
        case EQUALS:
            return compareNumber.equals(propertyNumber);
        case GREATER_THAN:
            return propertyNumber.compareTo(compareNumber) > 0;
