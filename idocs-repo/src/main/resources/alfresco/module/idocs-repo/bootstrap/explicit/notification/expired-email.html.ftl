...
НАПОМИНАНИЕ!! Срок рассмотрения договора <u>№ <#if args.contractId??>${args.contractId}</#if></u> дата <u><#if args.contractDate??>${args.contractDate}</#if></u> заключаемое с контрагентом <u><#if args.contractorName??>${args.contractorName}</#if></u> истек. <b>Необходимо рассмотреть в ближайшее время</b>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                     <table cellpadding="2" cellspacing="0" border="0">
                                                                        ...
                                                                        <tr>
                                                                           <td>Для загрузки документа нажмите на ссылку:</td>
                                                                        </tr>
                                                                        <tr>
                                                                           <td>
