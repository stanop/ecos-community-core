...
JournalsWidget
    ...
    .computed('fullscreenLink', function() {
        const isCurrentUserInGroup = function (group) {
        ...
        const checkJournalsAvailability = function () {
            return Citeck.Records.get("ecos-config@default-ui-new-journals-access-groups").load(".str")
