...
CreateVariant
	...
	.computed('link', function() {
		...
		var redirectionMethod = this.resolve("journal.type.options")["createVariantRedirectionMethod"];
		if (redirectionMethod) urlTemplate += "&onsubmit=" + encodeURIComponent(redirectionMethod);
