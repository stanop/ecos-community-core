...
define([
    ...
    var handyDoclist = null;
    var requireCallbacks = [];

    var withHandyDocList = function(callback) {
        if (handyDoclist == null) {
            requireCallbacks.push(callback);
        } else {
            callback.call(null, handyDoclist)
        }
    };

    Citeck.utils.requireInOrder([
        'yui/slider/slider',
        'xstyle!components/documentlibrary/actions.css',
        'components/documentlibrary/actions',
        'modules/documentlibrary/doclib-actions',
        'xstyle!components/documentlibrary/documentlist.css',
        'components/documentlibrary/documentlist',
        'components/documentlibrary/documentlist-view-detailed',
        'components/documentlibrary/documentlist-view-simple',
        'components/documentlibrary/documentlist-view-gallery'], function () {
        ...
        handyDoclist = Citeck.widget.HandyDocumentList;
        for (var i = 0; i < requireCallbacks.length; i++) {
            requireCallbacks[i].call(null, handyDoclist);
        }
    });

    return withHandyDocList;
});
