...
(function() {
    ...
    Citeck.forms.createUserInplaced = function(itemId, formId, callback, params) {
        var listId = params.listId;
        var itemKind, mode, paramName;
        formId = formId || "";
        ...
        var newDialog = function() {
            ...
            Alfresco.util.Ajax.request({
                method: "GET",
                url: Alfresco.constants.URL_PAGECONTEXT + "node-create",
                dataObj: dataObj,
                execScripts: true,
                successCallback: {
                    fn: function(response) {
        ...
        Alfresco.util.Ajax.jsonGet({
            ...
            failureCallback: { fn: function(response) {
                console.log('Error when call Citeck.forms.createUserInplaced [2]:', response);
            }}
        });*/
        newDialog();
    };
