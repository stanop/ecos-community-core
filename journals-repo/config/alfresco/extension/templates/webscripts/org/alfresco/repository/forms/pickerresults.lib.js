...
function createContractorResult(node) {
    var contractorTypeS = node.properties["{http://www.citeck.ru/model/content/clarumdms/1.0}contractor_type_added"];
    var nameS = node.properties.name;
    ...
    contractorObject.properties.name =  nameS;
    contractorObject.properties.modified = node.properties.modified;
    contractorObject.properties.modifier = node.properties.modifier;
