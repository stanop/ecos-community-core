 ...
 * @author PavelYur
 */
public class DefaultAuthenticationHandler implements AuthenticationHandler, ApplicationContextAware
{
	...
	public void setApplicationContext(ApplicationContext context)
		...
		this.permissionService = context.getBean("PermissionService", PermissionService.class);
        this.pathHelper = context.getBean("vtiPathHelper", VtiPathHelper.class);
	}
}
